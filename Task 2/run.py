...
lag = 100*u.day
mean_flux = 10*u.mJy
continuum, emission_line, continuum_emission_line = simulate_light_curves(observation_times,
                                                                          lag=lag,
                                                                          mean_continuum_flux=mean_flux,
                                                                          line_flux_ratio=2*u.mJy,  # line is twice as strong as the continuum
                                                                          log_gp_scale=2,
